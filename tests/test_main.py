...
class TestMainEntry:
    ...
    def test_main_calls_handle_cli(self):
        ...
        with patch('__main__.handle_cli') as mock_handle_cli:
    ...
    def test_main_starts_gui_when_cli_returns_start_gui(self):
        ...
        with patch('__main__.handle_cli') as mock_handle_cli, \
             patch('__main__.start_gui') as mock_start_gui:
...
class TestMainIntegration:
    ...
    def test_main_error_handling(self):
        ...
        with patch('__main__.handle_cli', side_effect=Exception("Test error")):
            # Should not crash
...
if __name__ == "__main__":
    ...
    def test_main_module_execution(self):
        ...
        try:
            ...
            pytest.fail("Could not import __main__ module")
...
class TestMainEdgeCases:
    ...
    def test_main_import_error_handling(self):
        ...
        with patch('__main__.handle_cli', side_effect=ImportError("Module not found")):
    ...
    def test_main_gui_import_error(self):
        ...
        with patch('__main__.handle_cli') as mock_handle_cli, \
             patch('__main__.start_gui', side_effect=ImportError("GUI not available")):
    ...
    def test_main_preserves_cli_exit_codes(self):
        ...
        with patch('__main__.handle_cli', side_effect=SystemExit(42)):
